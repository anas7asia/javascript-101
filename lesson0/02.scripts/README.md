...
+ Insérez le script `before-render.js` qui doit être téléchargé et éxecuté avant que le navigateur commence le rendu de la page.
+ Insérez le script `after-render.js` qui doit être téléchargé et executé après que la navigateur ait terminé le rendu de la page.
+ Insérez le script `whenever.js` qui doit être téléchargé et executé à n'import quel moment du rendu de la page par navigateur.
